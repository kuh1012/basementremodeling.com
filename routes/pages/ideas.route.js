...
router.use(async (request, response, next) => {
    ...
    request.data['viewIdea'] = request.query.viewIdea;
    next();
});
...
router.get(`/:categoryTitle`, async (request, response, next) => {
    ...
    content.page.pageTitle = `Basement ${capitalizeFirstLetter(categoryTitle)} | BasementRemodeling.com ideas`;
...
router.get(`/:categoryTitle/:subCategoryTitle`, async (request, response, next) => {
    ...
    content.page.pageTitle = `${capitalizeFirstLetter(subCategoryTitle)} for your basement | BasementRemodeling.com ideas`;
    const data = { ...request.data, ...content };
...
router.get(`/:categoryTitle/:subCategoryTitle/:childCategoryTitle`, async (request, response, next) => {
    ...
    content.page.pageTitle = `${capitalizeFirstLetter(childCategoryTitle)} ${capitalizeFirstLetter(subCategoryTitle)} for your basement | BasementRemodeling.com ideas`;
    const data = { ...request.data, ...content };
