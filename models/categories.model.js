    ...
    try {
        const query = `
            SELECT
                ...
                ideas_categories.categoryImage, ideas_categories.bottomText
...
const requestCategory = async (searchData, isURL) => {
    try {
        const query = `
            SELECT categoryID, categoryTitle, categoryLink, categoryImage,bottomText 
